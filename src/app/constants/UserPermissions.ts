...
export class UserPermissions {
    public static readonly Guest: UserPermission = new UserPermission(UserRole.Guest, [Routes.admin, Routes.messages, Routes.friends, Routes.account, Routes.forum, Routes.forumDetail], []);
